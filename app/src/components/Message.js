    ...
    <>
      {
        message.files.map((file, index) => (
          <div key={`message-file-${file.name + index}`} className={own ? 'message own' : 'message friend'}>
            <div className="messageTop">
              <img
                ...
                alt=""
              />
              <p onClick={() => onFileClick(file)} className="messageText hover"><FileOutlined /> {file.name}</p>
            </div>
